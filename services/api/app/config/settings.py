...
class Settings(BaseSettings):
    ...
    # fallback :3001 it picks if 3000 is busy, for both localhost and
    # 127.0.0.1 (some tooling, e.g. scripts/wait-ready.mjs, targets
    # 127.0.0.1 explicitly). Production deploys should override with the
